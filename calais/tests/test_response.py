...
ERROR_RESPONSE = '<Error Method="ProcessText" calaisRequestID="ed010f41-4ffb-c6fd-1355-de894f86ba51" CreationDate="2012-02-08 11:00:18" CalaisVersion="R4.3_7.1.1103.5"><Exception>Calais Backend-Server is Busy. Please try again later.</Exception></Error>"'
...
def test_busy():
    return CalaisResponse(ERROR_RESPONSE)
